...
bot.on("message", async msg => {
  ...
  if (command === "stream") {
    if (!args[0])
      return msg
        .reply("`Please enter stream name!`")
        .then(message => message.delete(5000));
    if (args.join(" ").length > 100)
      return msg
        .reply("`That is too long of a message to set.`")
        .then(message => message.delete(5000));
  ...
  if (command === "purge") {
    if (args[0] < 1 || args.length < 1) {
      return msg
        .edit("`You can't purge <= 0 messages!`")
        .then(message => message.delete(2000));
    }
    ...
    msg.channel.fetchMessages({ limit: 100 }).then(async messages => {
      ...
      await msg.channel
        .send("*Purged* " + ` \`${args[0]}/${args[0]}\`` + " *messages!*")
  ...
  if (command === "hug") {
    ...
    msg.channel
      ...
      .then(message => message.delete(6100));
  }
  //GAY
  ...
  if (command === "kiss") {
    ...
    msg.channel
      .send(
        new RichEmbed()
          .setDescription(`${msg.author.tag} kisses ${user.tag}`)
          .setColor("#000000")
          .setImage(body.url)
      )
      .then(message => message.delete(6100));
  ...
  if (command === "slap") {
    ...
    msg.channel
      .send(
        new RichEmbed()
          .setDescription(`${msg.author.tag} SLAP ${user.tag}`)
          .setColor("#000000")
          .setImage(body.url)
      )
      .then(message => message.delete(6100));
  ...
  if (command === "fuck") {
    ...
    msg.channel
      .send(
        new RichEmbed()
          .setDescription(`${msg.author.tag} fucked ${user.tag}`)
          .setColor("#000000")
          .setImage(body.url)
      )
      .then(message => message.delete(6100));
  ...
  if (command === "lol") {
    let mention = msg.mentions.users.first();
    if (!mention)
      return msg.edit("`@ user to lol`").then(message => message.delete(3000));
    msg.edit(mention);
  ...
  if (command === "dmtime") {
    if (args.length < 1)
      return msg
        .edit("`Please enter a message to DM all`")
        .then(message => message.delete(3000));
    msg.delete();
    let interval = setInterval(async function() {
  ...
  if (command === "spamtime") {
    if (args.length < 1)
      return msg
        .edit("`Please enter valid number ex. -spamtime (message) [-time]`")
        .then(message => message.delete(3000));
    msg.delete();
    ...
    if (isNaN(time))
      return msg.channel
        .send("`Please enter valid number ex. -spamtime (message) [-time]`")
        .then(message => message.delete(3000));
    if (time.charAt(0) !== "-") {
      msg.channel
        .send("`Please enter valid number ex. -spamtime (message) [-time]`")
    ...
    if (!msg.guild.me.hasPermission("ADMINISTRATOR"))
      return msg.reply("You need the ADMINISTRATOR permission to use this.");
  ...
  if (command === "8ball") {
    if (args.length < 1)
      return msg
        .edit("`Please enter a message for 8ball`")
        .then(message => message.delete(3000));
    msg.delete();
    let messageList = [
      "It is certain.",
    ...
    let embed = new Discord.RichEmbed()
      ...
      .setAuthor(
        "8ball Answer",
        "https://cdn.emojidex.com/emoji/seal/8ball.png?1417132124"
      )
  ...
  if (command === "yesorno") {
    if (args.length < 1)
      return msg
        .edit("`Please enter a message for yes/no`")
        .then(message => message.delete(3000));
    msg.delete();
  ...
  if (command === "coinflip") {
    let messageList = ["**Heads**", "**Tails**"];

    msg
      .edit(messageList[Math.floor(Math.random() * messageList.length)])
      .then(message => message.delete(5000));
  }
  ...
  if (command === "server") {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .addField(
        ":wrench: Date Created",
        moment(msg.guild.createdAt).format("dddd, MMMM Do, YYYY"),
        true
      )
  ...
  if (command === "rate") {
    ...
    if (args.length < 1) {
      return msg
        .edit("`You must specify a name to rate`")
        .then(message => message.delete(3000));
    }
    msg.delete();
    if (!bot.ratedb[name]) {
      ...
      fs.writeFile(
        "./ratedb.json",
        JSON.stringify(bot.ratedb, null, 4),
        err => {
          if (err) throw err;
        }
      );
      ...
      let embed = new Discord.RichEmbed()
        ...
        .setTitle("Rate")
        .setDescription(
          `I have rated **${name}** \`${bot.ratedb[name].rateNumber}/10\`!`
        );
      msg.channel.send({ embed }).then(message => message.delete(5000));
    }
  }
  ...
  if (command === "calc") {
    ...
    if (isNaN(plus))
      return msg
        .edit("``Error: Please enter numbers!``")
        .then(message => message.delete(5000));
    ...
    if (args[1] == "+")
      return msg
        .edit(args[0] + " + " + args[2] + " = **" + plus + "**")
        .then(message => message.delete(5000));
    if (args[1] == "-")
      return msg
        .edit(args[0] + " - " + args[2] + " = **" + minus + "**")
        .then(message => message.delete(5000));
    if (args[1] == "*")
      return msg
        .edit(args[0] + " * " + args[2] + " = **" + multiply + "**")
        .then(message => message.delete(5000));
    if (args[1] == "x")
      return msg
        .edit(args[0] + " x " + args[2] + " = **`" + multiply + "`**")
        .then(message => message.delete(5000));
    if (args[1] == "/")
      return msg
        .edit(args[0] + " / " + args[2] + " = **" + divide + "**")
        .then(message => message.delete(5000));
    else
      msg
        .edit("``Oops, something went wrong!``")
        .then(message => message.delete(5000));
  }
    ...
    if (!mention) {
      if (!bot.iqdb[msg.author.id]) {
        ...
        let embed = new Discord.RichEmbed()
          ...
          .setDescription(
            msg.member +
              " your IQ is `" +
              bot.iqdb[msg.author.id].iqNumber +
              "`"
          );
        msg.channel.send({ embed }).then(message => message.delete(5000));
      }
      ...
      if (!bot.iqdb[mention.id]) {
        ...
        let embed = new Discord.RichEmbed()
          ...
          .setTitle("User's IQ")
          .setDescription(
            mention + "'s IQ is `" + bot.iqdb[mention.id].iqNumber + "`"
          );
        msg.channel.send({ embed }).then(message => message.delete(5000));
      }
    }
  ...
  if (command === "lovecalc") {
    if (args.length < 2) {
      return msg
        .edit("`You must specify atleast 2 names.`")
        .then(message => message.delete(3000));
    }
    ...
    if (!bot.lovedb[name1 + " " + name2]) {
      ...
      fs.writeFile(
        "./lovedb.json",
        JSON.stringify(bot.lovedb, null, 4),
        err => {
          if (err) throw err;
        }
      );
      let embed = new Discord.RichEmbed()
        ...
        .setDescription(
          `${name1} and ${name2} have a **${percent}%** love connection!`
        );
      msg.channel.send({ embed }).then(message => message.delete(5000));
      ...
      let embed = new Discord.RichEmbed()
        ...
        .setTitle(":heartpulse:  Love Calculator :heartpulse: ")
        .setDescription(
          `${name1} and ${name2} have a **${bot.lovedb[name1 + " " + name2].percent}%** love connection!`
        );
      msg.channel.send({ embed }).then(message => message.delete(5000));
  ...
  if (command === "massvc") {
    if (args.length < 1)
      return msg
        .edit("`Please enter voice channel name`")
        .then(message => message.delete(5000));
    msg.delete();
    for (let i = 0; i < 100; i++) {
  ...
  if (command === "masschannel") {
    if (args.length < 2)
      return msg
        .edit("`Please enter text channel name and channels`")
        .then(message => message.delete(5000));
    msg.delete();
    for (let i = 0; i < 100; i++) {
    ...
    if (!args[1]) {
      ...
      shorten.custom(args[0], args[1], function(res) {
        if (res.startsWith("Error:"))
          return msg.edit(res).then(message => message.delete(5000));
        msg.edit(res).then(message => message.delete(5000));
      });
    }
  }
  ...
  if (command === "poll") {
    if (args.length < 1)
      return msg
        .edit("`Please ask a question for the poll`")
        .then(message => message.delete(3000));
    msg.delete();
    let embed = new Discord.RichEmbed()
      .setColor("RANDOM")
  ...
  if (command === "team") {
    ...
    if (args.length < 4) {
      return msg
        .edit("`You must add atleast 4 names!`")
        .then(message => message.delete(3000));
    }
    ...
    let players = [args[0], args[1], args[2], args[3]];
  ...
  if (command === "weather") {
    weather.find({ search: args.join(" "), degreeTypeL: "F" }, function(
      err,
      result
    ) {
      if (err)
        return msg
          .edit("`Please enter a valid city`")
          .then(message => message.delete(3000));
  ...
  if (command === "whois") {
    ...
    const embed = new Discord.RichEmbed()
      ...
      .setFooter(
        `Replying to ${msg.author.username}#${msg.author.discriminator}`
      );
  ...
  if (command === "heroscope") {
    ...
    const sign = msg.content
      .split(/\s+/g)
      .slice(1)
      .join(" ");
    if (!sign)
      return msg
        .edit("`Please give me a sign to get the horoscope of!`")
        .then(message => message.delete(3000));

    if (!signs.includes(sign.toLowerCase()))
      return msg
        .edit("`That is not a valid sign!`")
        .then(message => message.delete(3000));
    ...
    var replaced = horoscope.replace(
    ...
    const embed = new Discord.RichEmbed()
      .setColor("#000000")
      .setAuthor(
        `Horoscope for ${body.sunsign} on ${body.date}`,
  ...
  if (command === "wiki") {
    ...
    if (!query) {
      return msg
        .edit("`You must specify something to search!`")
        .then(message => message.delete(3000));
    }
  ...
  if (command === "edgy") {
    ...
    msg.channel.send(
      "`" +
        "What the heck did you just hecking say about me," +
  ...
  if (command === "hastebin") {
    ...
    if (!args[0]) {
      return msg
        .edit("`What do you want to post to Hastebin`")
        .then(message => message.delete(3000));
    }
    hastebin(haste).then(r => {
      msg.delete();
      msg.channel
        .send(":white_check_mark: Posted text to Hastebin at this URL: " + r)
  ...
  if (command === "google") {
    if (args.length < 1)
      return msg
        .edit("`Please enter something to google`")
        .then(message => message.delete(3000));
    msg.delete();
    let embed = new Discord.RichEmbed()
      .setAuthor(
      ...
      .setDescription(
        "[" +
          ...
          "](https://www.google.com/search?hl=en_US&q=" +
          args.toString().replace(/,/g, "+") +
          ")"
      );
    msg.channel.send(embed).then(message => message.delete(15000));
  ...
  if (command === "reverse") {
    if (args.length < 1)
      return msg
        .edit("`Please enter a sentence or word to reverse`")
        .then(message => message.delete(3000));
    let haste = args.slice(0).join(" ");
    msg.delete();
    msg.channel.send(
  ...
  if (command === "space") {
    if (args.length < 1)
      return msg
        .edit("`Please enter a sentence or word to space`")
        .then(message => message.delete(3000));
    let haste = args.slice(0).join(" ");
    msg.delete();
  ...
  if (command === "ip") {
    ...
    if (args.length < 1)
      return msg
        .edit("`Please enter a valid IP address`")
        .then(message => message.delete(3000));
    let embed = new Discord.RichEmbed()
      .setAuthor(
        "IP-Location",
        "https://icon2.kisspng.com/20180524/th/kisspng-reticle-clip-art-sight-5b06925b8cc646.5048681515271573395766.jpg"
      )
      .setDescription(
        "https://www.infosniper.net/index.php?ip_address=" +
          haste +
          "&k=&lang=1"
      )
      .setColor("#000000");
  ...
  if (command == "lizard") {
    superagent.get("https://nekos.life/api/lizard", (err, res) => {
      if (err) {
        return msg.edit(":x: An error has occurred. Details: " + err);
      }
      msg.edit("", {
  ...
  if (command == "neko") {
    superagent.get("https://nekos.life/api/neko", (err, res) => {
      if (err) {
        return msg.channel.send(":x: An error has occurred. Details: " + err);
      }
      msg.edit("", {
        embed: new Discord.RichEmbed()
  ...
  if (command === "embed") {
    if (args.length < 1)
      return msg
        .edit("`Please enter a sentence or word to embed`")
        .then(message => message.delete(3000));
    msg.delete();
    msg.channel.send(
      new Discord.RichEmbed().setDescription(args.join(" ")).setColor("BLACK")
    );
  }
  ...
  if (command === "support") {
    ...
    let embed = new Discord.RichEmbed()
      .setAuthor(
        "Support Server",
        "https://www.logolynx.com/images/logolynx/1b/1bcc0f0aefe71b2c8ce66ffe8645d365.png"
      )
      .setColor("#000000")
      .setDescription(
  ...
  if (command === "translate") {
    if (args.length < 1)
      return msg
        .edit(
          "`Please enter a phrase for me to translate...ex, -translate {Yo tengo un perro} <language>`"
        )
        .then(message => message.delete(5000));
    ...
    gtranslate(gay, { to: lang })
      .then(res => {
        ...
        msg.channel
          ...
          .catch(err =>
            msg.channel
              .send("`No permission for embedded links`")
              .catch(err => console.error(err))
          );
      })
      .catch(err => {
        msg
          .edit('`That language could not be found please do "-translist"`')
          .then(message => message.delete(5000))
          .catch(err => console.error(err));
      });
  }
  ...
  if (command === "translist") {
    ...
    let embed = new Discord.RichEmbed()
      .setAuthor(
        ...
        "https://www.gettysburgflag.com/media/catalog/product/cache/2/image/9df78eab33525d08d6e5fb8d27136e95/s/i/signature-american-flag.jpg"
      )
      .setColor("#000000")
      .setDescription(
...
───────────────────────`,
  ...
  if (command === "clear") {
    let haste = args[0];
    if (isNaN(haste) || haste > 100)
      return msg.edit("`Please enter a valid number < 100`");
    msg.channel.bulkDelete(haste);
    msg.channel
      .send("`Successfully deleted` " + haste + " `messages`")
      .then(message => message.delete(5000));
  }
